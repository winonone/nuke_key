...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_5x6(
     ...
     KC_TAB , KC_Z  , KC_X  , KC_C  , KC_V  , KC_B  ,                         KC_K  , KC_M  ,KC_COMM, KC_DOT, KC_SLSH ,KC_BSLASH,
                       KC_MS_BTN1, KC_MS_BTN2,                                                     KC_LBRC,KC_RBRC,
                                      KC_LSFT,  KC_SPC,                   KC_MS_BTN3, KC_BSPC,
                                      KC_LCTL,  KC_ENT,                   _______,    KC_LGUI,
                                      KC_LALT,  KC_ESC,                   KC_LALT,  KC_DEL
  ),
